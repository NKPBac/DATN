...
@endsection
@section('title','PHUONGBAC || PRODUCT DETAIL')
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">{{number_format($after_discount,2)}}đ</span>
                                                    @if($product_detail->discount > 0)
                                                    <s>{{number_format($product_detail->price,2)}} đ</s>
                                                    @endif
                                                </p>
											...
											@if($product_detail->size)
												<div class="size mt-4" style="padding-right:100px">
													<h4>Màu</h4>
													<ul class="color-list">
														@php
...
<style>
    .active {
        /* Định dạng CSS cho thuộc tính active */
		font-weight: bold; 
